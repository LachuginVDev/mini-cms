...
@section('content')
    <div class="max-w-2xl mx-auto px-6 py-12">
        <h1 class="text-3xl font-bold mb-10">Создать новую категорию</h1>
        ...
        <form action="{{ route('user.categories.store') }}" method="POST" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6">
            @csrf
            ...
            <div class="space-y-2">
                ...
                <p class="mt-1 text-sm text-slate-500">Slug будет автоматически сгенерирован из названия</p>
            </div>
