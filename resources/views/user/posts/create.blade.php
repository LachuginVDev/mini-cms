...
@section('content')
    <div class="max-w-4xl mx-auto px-6 py-12">
        <h1 class="text-3xl font-bold mb-10">Создать новый пост</h1>
        ...
        <form action="{{ route('user.posts.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6">
            @csrf
            ...
            <div class="space-y-2">
                ...
                <textarea id="meta_description" 
                          ...
                          rows="3" 
                          class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 transition resize-y text-slate-800">{{ old('meta_description') }}</textarea>
